package com.bladecore.client.manager.managers.data.controllers
...
import com.bladecore.client.manager.managers.data.DataController
import com.bladecore.client.manager.managers.data.DataUtils.getModuleByName
...
object SettingsDataController : DataController(
    ...
    File(BladeCore.DIR + "/settings.bc")
) {
    override fun onLoad() {
