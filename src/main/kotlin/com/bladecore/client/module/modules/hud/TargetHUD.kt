...
import com.bladecore.client.module.modules.combat.CrystalAura
...
object TargetHUD : DraggableHudModule(
    ...
    private fun update() {
        ...
        if (info.name == "BladeCore  " && !HudEditor.isEnabled()) info = TargetInfo(info.name, 0.0, info.maxHealth, info.entity)
    ...
    private class TargetInfo(val name: String, val health: Double, val maxHealth: Double, val entity: EntityLivingBase?) {
        ...
        companion object {
            ...
            val SELF = TargetInfo("BladeCore  ", 20.0, 20.0, null)
        }
